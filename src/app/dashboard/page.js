...
export default function DashboardPage() {
  ...
  const filteredTasks = tasks.filter((task) => {
    ...
    const normalizedTaskDate = new Date(Date.UTC(taskDate.getFullYear(), taskDate.getMonth(), taskDate.getDate()));
    const normalizedSelectedDate = new Date(selectedDate + 'T00:00:00Z');
